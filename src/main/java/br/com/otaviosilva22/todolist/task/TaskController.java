package br.com.otaviosilva22.todolist.task;
...
import br.com.otaviosilva22.todolist.utils.Utils;
...
public class TaskController {
    ...
    public ResponseEntity updateTask(@RequestBody TaskModel taskModel, HttpServletRequest request, @PathVariable UUID id){
        ...
        if (task.getIdUser() != request.getAttribute("idUser")){
            return ResponseEntity.status(400).body("Usuário sem permissão para autoerar essa tarefa");
        }
